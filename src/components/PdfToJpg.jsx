...
function canvasToJpg(canvas, quality) {
  return new Promise((resolve, reject) => {
    canvas.toBlob(
      (blob) => {
        if (!blob) {
          reject(new Error("Unable to generate the JPG image."));
          return;
        }
    ...
    try {
      ...
      for (
        ...
        try {
          ...
          if (!context) {
            throw new Error(
              "Your browser cannot create the JPG image."
            );
          }
      ...
      if (singleImage) {
        ...
        setSuccess(
          "JPG image downloaded successfully!"
        );
      } else {
        const zipBlob =
        ...
        setSuccess(
          `${selectedPages.length} JPG images downloaded as a ZIP file!`
        );
      }
    } catch (err) {
      console.error(err);
  ...
  return (
    <main className="converter-page">
      ...
      <div className="converter-header">
        ...
        <p>
          Convert PDF pages into high-quality
          JPG images.
        </p>
      </div>
      ...
      {selectedFile && (
        <>
          ...
          <div className="pdf-settings">
            ...
            >
              A single selected page
              downloads as JPG. Multiple
              pages download together
              as a ZIP file.
            </p>
          </div>
